    ...
    <footer className="bg-gray-900 pt-16 pb-8">
      <div className="container-width">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            <RiaLogo className="h-8 w-auto text-brand-500 mb-4" />
            <p className="text-gray-400 text-sm leading-relaxed">Moving money for families since 1987.</p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-xs">© 2024 Ria Financial Services, Inc. NMLS ID #920968. All rights reserved.</p>
          <div className="flex gap-6">
            {['Privacy', 'Terms', 'Cookies'].map(link => (
              <a key={link} href="#" className="text-gray-400 text-xs hover:text-gray-300">{link}</a>
            ))}
          </div>
        </div>
